...
@Documented
@Constraint(validatedBy = { PatternValidator.class, PatternValidatorEnum.class })
public @interface CustomPattern {
     ...
     */
    String message() default "{jakarta.validation.constraints.CustomPattern.message}";
    ...
    /**
     * Defines several {@link jakarta.validation.constraints.Pattern} annotations on the same element.
     *
